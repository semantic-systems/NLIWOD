...
public class UnitEnglishTest {
	...
	public void hawkParseTest() {
		...
		sentenceToSentence.put("Where was the first race for the greatest Formula One driver of all times?", "Where was the first race for the greatest Formula One driver of all times?");
		...
		sentenceToSentence.put("Which cities have more than 2 million inhabitants?", "Which cities have more than 2 million inhabitants?");
		...
		sentenceToSentence.put("List the seven kings of Rome.", "List the seven kings of Rome.");

		for (String it : sentenceToSentence.keySet()) {
			if (!sentenceToSentence.get(it).equals(unit.convert(it))) {
