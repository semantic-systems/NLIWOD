...
public class SPARQLEvaluation {
	...
	public static void main(String[] args) throws Exception {
		...
		precision = SPARQLEvaluation.precision(sparqlQuery, targetSPARQLQuery, endpoint);
		recall = SPARQLEvaluation.recall(sparqlQuery, targetSPARQLQuery, endpoint);
		fMeasure = SPARQLEvaluation.fMeasure(sparqlQuery, targetSPARQLQuery, endpoint);
		System.out.println("P=" + precision + "\nR=" + recall + "\nF=" + fMeasure);
